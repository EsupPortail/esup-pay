...
privileged aspect ExportTransaction_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> ExportTransaction.fieldNames4OrderClauseFilter = java.util.Arrays.asList("numTransaction", "numRemise", "transactionDate", "dateRemise", "numContrat", "reference", "montant", "statut", "email", "typeTransaction");
