...
privileged aspect PayEvtMontant_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> PayEvtMontant.fieldNames4OrderClauseFilter = java.util.Arrays.asList("evt", "title", "description", "help", "field1Label", "field2Label", "dbleMontant", "urlId", "freeAmount", "sciencesconf", "addPrefix");
